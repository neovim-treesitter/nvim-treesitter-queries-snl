# nvim-treesitter-queries-snl

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-snl/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-snl/actions/workflows/validate.yml)

Neovim tree-sitter queries for **snl**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-snl",
...
- [ ] Changes are scoped to `snl` — do not include files for other languages
